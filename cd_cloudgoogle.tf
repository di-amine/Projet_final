...
resource "google_compute_instance" "mogodb1" {
  name         = "${var.namevm1}"
...
resource "google_compute_instance" "mogodb2" {
  name         = "${var.namevm2}"
  machine_type = "${var.machine_type}"
  zone         = "${var.zonevm}"
...
resource "google_container_node_pool" "test_preemptible_nodes2" {
...
output "client_certificate" {
  value = "${google_container_cluster.prod.master_auth.0.client_certificate}"
  value = "${google_container_cluster.test.master_auth.0.client_certificate}"
}

output "client_key" {
  value = "${google_container_cluster.prod.master_auth.0.client_key}"
